...
from prompts.stakeholder_prompts import create_qa_prompt
...
def chat_bot_invoke(chain):
    ...
    with col1:
        user_input = st.text_input("", placeholder="e.g., Is there a relationship between Bug ID 77603 and User_Story ID 74867?")
        responses = []
    ...
    if st.button("Save Session"):
        ...
        folder_path = r"C:\Development\RE2025_grag"
